...
Copy EvenytServer-3.0.2.jar from the `target` folder and all other libraries located in `target/lib` to your project's lib folder.
...
myModel.setWarehouse(warehouse);
